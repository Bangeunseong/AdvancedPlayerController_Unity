...
//     version 1.14.2
//     from Assets/Project/Scripts/Input/PlatformerInputAction.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Project/Scripts/Input/PlatformerInputAction.inputactions".
/// </summary>
/// <remarks>
...
public partial class @PlatformerInputAction: IInputActionCollection2, IDisposable
{
    ...
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, PlatformerInputAction.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, PlatformerInputAction.UI.Disable() has not been called.");
    }
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@PlatformerInputAction wrapper) { m_Wrapper = wrapper; }
        /// <summary>
